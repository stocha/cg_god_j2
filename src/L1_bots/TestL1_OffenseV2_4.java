 ...
 * @author Jahan
 */
public class TestL1_OffenseV2_4 extends L1_botStruct.BotBase {

    public TestL1_OffenseV2_4(int P, int Id, int D, int Z) {
        super(P, Id, D, Z);
    }

    public static L1_botStruct.BotFactory fact = (int P1, int Id1, int D1, int Z1) -> new TestL1_OffenseV2_4(P1, Id1, D1, Z1);

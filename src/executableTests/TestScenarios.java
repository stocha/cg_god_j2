...
public class TestScenarios {
 ...
 WorldBase w=new WorldBase(3, 4, 9966666,true,  new TesterBot(TestL1_OffenseV2_6.fact), new TesterBot(TestL1_OffenseV2_6.fact)); // 1 vs 1                    
       
      // WorldBase w=new WorldBase(3, 4, 9966666,true,  new TesterBot(TestL1_OffenseV2_6.fact), new TesterBot(TestL2_Bi_P2_OnduleV2.fact)); // 1 vs 1             
